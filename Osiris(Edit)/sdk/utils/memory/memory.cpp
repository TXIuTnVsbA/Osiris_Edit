...
void c_memory::init() noexcept {
    ...
    clientMode = **reinterpret_cast<ClientMode***>((*reinterpret_cast<uintptr_t**>(g_interfaces.client))[10] + 5);
    input = *reinterpret_cast<Input**>((*reinterpret_cast<uintptr_t**>(g_interfaces.client))[16] + 1);
    globalVars = **reinterpret_cast<GlobalVars***>((*reinterpret_cast<uintptr_t**>(g_interfaces.client))[11] + 10);
